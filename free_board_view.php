...
?>
					<li>
						<button type="button" onclick="location.href='free_board_modify_form.php?num=<?=$num?>&page=<?=$page?>'">수정</button>
					</li>
					<li>
						<button type="button" onclick="location.href='./free_board_delete.php?num=<?=$num?>&page=<?=$page?>'">삭제</button>
...
?>
					...
					<li>
						<button type="button" onclick="location.href='./free_board_form.php'">작성하기</button>
					</li>
<?php
	}
?>
